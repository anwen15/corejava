...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO()  {
        ...
        try {
            ...
            e.printStackTrace();
            throw new daoexception("构造 error");
        }
    ...
    protected int executeUpdate(String sql , Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new daoexception("basedao excuteupdate error");
        }
    ...
    private void setValue(Object obj ,  String property , Object propertyValue) throws NoSuchFieldException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException {
        ...
        if (field != null) {
            //获取类型,如果是自定义类型,则需要调用这个自定义类的构造方法
            String typename = field.getType().getName();
            if(ismytype(typename)){
                Class aClass = Class.forName(typename);
                Constructor constructor = aClass.getDeclaredConstructor(Integer.class);
    ...
    private static boolean isnotmytype(String name){
    ...
    protected Object[] executeComplexQuery(String sql , Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new daoexception("complexquery error,可能未指定<>");
        }
        return null;
    }
    ...
    protected T load(String sql , Object... params){
        ...
        try {
            ...
            e.printStackTrace();
            throw new daoexception("load error");
        }
        return null ;
    }
    ...
    protected List<T> executeQuery(String sql , Object... params){
        ...
        try {
            ...
            e.printStackTrace();
            throw new daoexception("excutequery error");
        }
        return list ;
    }
}
